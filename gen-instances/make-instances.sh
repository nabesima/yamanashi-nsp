...
NURSES_LIST=(5 10 20 40)
DAYS_LIST=(7 14 28)
STAFF_REQUEST_LIST=(0.00 0.10)
PAIRS=(0 2)
        ...
        for STAFF_REQUEST in "${STAFF_REQUEST_LIST[@]}"; do
            if [ "$NURSES" -ge 20 ]; then
                for PAIR in "${PAIRS[@]}"; do
                    ...
                    OUTPUT_FILE="${OUTPUT_DIR}/nsp-n${NURSES}-d${DAYS}-r${STAFF_REQUEST}-rp${RECOMMENDED_PAIRS}-fp${FORBIDDEN_PAIRS}.lp"
